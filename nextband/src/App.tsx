...
const AdminClassOperations = lazyWithRetry(() => import("@/pages/admin/ClassOperations"));
          ...
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              >
                ...
                />
                <Route
                  path="/admin/class-operations"
                  element={
                    <ProtectedRoute requiredRoles={["admin", "staff"]}>
                      <AdminClassOperations />
                    </ProtectedRoute>
                  }
                />
                <Route
