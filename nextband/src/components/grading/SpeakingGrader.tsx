    ...
    <div className="flex-1 bg-white flex flex-col justify-between overflow-hidden">
      ...
      <div className="p-3.5 border-b border-slate-200 bg-slate-50/50 flex items-center justify-between shrink-0">
        <div>
          ...
          <div className="text-[11px] text-slate-600 font-medium flex items-center gap-2 mt-1">
            ...
            <span>•</span>
            <span className="text-slate-500">Overall Band: {overallBandPreview}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="h-8 text-xs font-bold gap-1.5 border-slate-300 text-slate-700 hover:bg-slate-100"
          >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {activeAnswer.questionText && (
          <Card className="border border-slate-200/80 shadow-2xs rounded-xl p-3 bg-slate-50/50 space-y-1">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Đề bài</span>
        ...
        <Card className="border border-slate-200/80 shadow-2xs rounded-xl p-4 bg-orange-50/30 space-y-3">
          ...
          {activeAnswer.audioUrl ? (
            ...
            <div className="p-6 text-center text-xs text-slate-400 bg-white rounded-xl border border-dashed border-slate-200 flex flex-col items-center gap-2">
              <FileAudio className="h-8 w-8 text-slate-300" />
              <span>Học viên chưa nộp bản thu âm cho phần này.</span>
            </div>
          )}
        </Card>
        ...
        <Card className="border border-slate-200/80 shadow-2xs rounded-xl p-3.5 space-y-2 bg-white">
          ...
          <Textarea
            ...
            placeholder="Gõ nhận xét cho bài nói của học viên (Ví dụ: Phát âm rõ ràng, tuy nhiên Part 2 cần phát triển thêm ý về...)"
            className="min-h-[85px] text-xs font-sans border-slate-200 focus-visible:ring-1 focus-visible:ring-blue-500/40"
          />
        </Card>

        {/* Revision / Attempt 2 Control Section */}
        <Card className="border border-slate-200/80 shadow-2xs rounded-xl p-3.5 space-y-3 bg-white">
          <div className="flex items-center justify-between">
